...
/// The committed gate configuration (spec 008 §2, gate config v1).
#[derive(Deserialize)]
...
/// The gate decision plus the gate's stable config hash (spec 008 §2: the
...
mod tests {
    ...
    /// config drift visible in review (spec 008 §2).
